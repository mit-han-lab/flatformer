...
class BaseInstance3DBoxes(object):
    ...
    def overlaps(cls, boxes1, boxes2, mode='iou'):
        ...
        assert mode in ["iou", "iof", "iou_correspond"]
        ...
        # height overlap
        overlaps_h = cls.height_overlaps(boxes1, boxes2, mode=mode)
        ...
        if mode != "iou_correspond":
            ...
            assert boxes1_bev.shape[0] == boxes2_bev.shape[0]
            overlaps_bev = boxes1_bev.new_zeros(boxes1_bev.shape[0])
            iou3d_cuda.correspond_boxes_overlap_bev_gpu(
                boxes1_bev.contiguous().cuda(),
                boxes2_bev.contiguous().cuda(),
                overlaps_bev,
            )
