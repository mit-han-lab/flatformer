...
void correspondBoxesoverlapLauncher(const int num, const float *boxes_a,
...
int correspond_boxes_overlap_bev_gpu(at::Tensor boxes_a, at::Tensor boxes_b,
                          at::Tensor ans_overlap) {
  // params boxes_a: (M, 5) [x1, y1, x2, y2, ry]
  // params boxes_b: (M, 5)
  // params ans_overlap: ( M)
  ...
  correspondBoxesoverlapLauncher(num, boxes_a_data, boxes_b_data,
                       ans_overlap_data);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("correspond_boxes_overlap_bev_gpu", &correspond_boxes_overlap_bev_gpu,
        "oriented boxes overlap (corresponded)");
